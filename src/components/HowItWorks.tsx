...
/* A hand-drawn pencil arrow sitting in the gap between steps (desktop only), so
   the three cards read as one flow: gather → curate → export. */
function StepArrow() {
  return (
    <div className="hidden shrink-0 items-center px-1 lg:flex" aria-hidden>
      <svg width="46" height="24" viewBox="0 0 46 24" className="text-ink" fill="none">
        <path
          d="M2 13 C 14 8, 26 8, 38 12"
          stroke="currentColor"
          strokeOpacity="0.32"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
        <path
          d="M38 12 l-6 -1.5 M38 12 l-4.5 4.6"
          stroke="currentColor"
          strokeOpacity="0.32"
          strokeWidth="1.4"
          strokeLinecap="round"
  ...
  return (
    <section id="how" className="relative py-14 sm:py-24">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-10">
        ...
        <div className="mt-14 flex flex-col gap-6 lg:flex-row lg:items-stretch lg:gap-0">
          {steps.map((step, i) => (
            <div key={step.id} className="contents">
              ...
              <Reveal delay={i * 120} className="flex flex-1">
