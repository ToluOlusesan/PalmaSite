  ...
  return (
    <section id="focus" className="relative bg-panel py-24 sm:py-32">
      <div className="mx-auto max-w-[1200px] px-6 sm:px-10">
        ...
        {/* Placeholder: the Focus caricature stands in until a real screenshot
            of Focus mode is dropped in (swap this block for an <Image>). */}
        <Reveal delay={120} className="mt-14">
          <div className="mx-auto max-w-[960px] overflow-hidden rounded-xl border border-line-2 bg-paper shadow-lift sm:rounded-2xl">
